...
def read_dataset():
    data_list = []
    label_list = []
    my_list = os.listdir(r'C:\Users\hp\Desktop\videosurveillance\videosurveillance\static\archive')
    i=0
    for pa in my_list:

        print(pa,"==================",i)
        for root, dirs, files in os.walk(r'C:\Users\hp\Desktop\videosurveillance\videosurveillance\static\archive\\' + pa):

         for f in files:
             try:
                file_path = os.path.join(r'C:\Users\hp\Desktop\videosurveillance\videosurveillance\static\archive\\'+pa, f)
...
#
# # Plotting accuracy vs epochs including validation accuracy
...
# plt.show()
#
# # Plotting loss vs epochs including validation loss
...
if not os.path.exists("model112.h5"):

    model.fit_generator(train_generator, steps_per_epoch=batch_size, epochs=epochs)
    model.save("model64.h5")  # train for randomly selected one
else:
